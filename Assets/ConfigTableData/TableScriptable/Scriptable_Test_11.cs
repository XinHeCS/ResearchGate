...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_11.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_11 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_11> _entitise = new List<Entity_Test_11>();

    public Entity_Test_11 this[int index] 
	{
		get 
		{

...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_16.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_16 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_16> _entitise = new List<Entity_Test_16>();

    public Entity_Test_16 this[int index] 
	{
		get 
		{

...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_6.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_6 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_6> _entitise = new List<Entity_Test_6>();

    public Entity_Test_6 this[int index] 
	{
		get 
		{

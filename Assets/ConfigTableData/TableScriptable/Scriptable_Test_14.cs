...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_14.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_14 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_14> _entitise = new List<Entity_Test_14>();

    public Entity_Test_14 this[int index] 
	{
		get 
		{

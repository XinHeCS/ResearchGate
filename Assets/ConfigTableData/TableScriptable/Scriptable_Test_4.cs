...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_4.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_4 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_4> _entitise = new List<Entity_Test_4>();

    public Entity_Test_4 this[int index] 
	{
		get 
		{

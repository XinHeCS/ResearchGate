...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_1.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_1 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_1> _entitise = new List<Entity_Test_1>();

    public Entity_Test_1 this[int index] 
	{
		get 
		{

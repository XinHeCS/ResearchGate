...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_2.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_2 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_2> _entitise = new List<Entity_Test_2>();

    public Entity_Test_2 this[int index] 
	{
		get 
		{

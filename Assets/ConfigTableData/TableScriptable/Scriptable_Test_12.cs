...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_12.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_12 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_12> _entitise = new List<Entity_Test_12>();

    public Entity_Test_12 this[int index] 
	{
		get 
		{

...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_0.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_0 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_0> _entitise = new List<Entity_Test_0>();

    public Entity_Test_0 this[int index] 
	{
		get 
		{

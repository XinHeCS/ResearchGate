...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_13.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_13 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_13> _entitise = new List<Entity_Test_13>();

    public Entity_Test_13 this[int index] 
	{
		get 
		{

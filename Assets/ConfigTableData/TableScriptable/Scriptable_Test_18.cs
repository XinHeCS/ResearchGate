...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_18.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_18 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_18> _entitise = new List<Entity_Test_18>();

    public Entity_Test_18 this[int index] 
	{
		get 
		{

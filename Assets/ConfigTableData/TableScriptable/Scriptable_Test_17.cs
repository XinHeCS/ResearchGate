...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_17.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_17 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_17> _entitise = new List<Entity_Test_17>();

    public Entity_Test_17 this[int index] 
	{
		get 
		{

...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_15.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_15 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_15> _entitise = new List<Entity_Test_15>();

    public Entity_Test_15 this[int index] 
	{
		get 
		{

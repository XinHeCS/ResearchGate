...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_8.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_8 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_8> _entitise = new List<Entity_Test_8>();

    public Entity_Test_8 this[int index] 
	{
		get 
		{

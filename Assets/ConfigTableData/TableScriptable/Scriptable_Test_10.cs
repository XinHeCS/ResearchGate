...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_10.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_10 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_10> _entitise = new List<Entity_Test_10>();

    public Entity_Test_10 this[int index] 
	{
		get 
		{

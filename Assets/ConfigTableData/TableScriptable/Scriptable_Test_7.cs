...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_7.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_7 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_7> _entitise = new List<Entity_Test_7>();

    public Entity_Test_7 this[int index] 
	{
		get 
		{

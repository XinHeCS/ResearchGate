...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_19.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_19 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_19> _entitise = new List<Entity_Test_19>();

    public Entity_Test_19 this[int index] 
	{
		get 
		{

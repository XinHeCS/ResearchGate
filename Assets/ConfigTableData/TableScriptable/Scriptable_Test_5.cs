...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_5.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_5 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_5> _entitise = new List<Entity_Test_5>();

    public Entity_Test_5 this[int index] 
	{
		get 
		{

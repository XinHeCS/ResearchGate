...
[TableAsset(AssetPath = Config.TableDataPath, ExcelPath = "Assets/ConfigTable/Test_3.xlsx", LogOnImport = Config.LogOnImport)]
public class Scriptable_Test_3 : ScriptableObject
{
	[SerializeField]
	List<Entity_Test_3> _entitise = new List<Entity_Test_3>();

    public Entity_Test_3 this[int index] 
	{
		get 
		{
